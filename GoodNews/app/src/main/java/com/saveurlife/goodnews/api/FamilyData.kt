...
data class ResponsePlaceInfo(val success:Boolean, val message:String, val data:PlaceInfo)

data class PlaceDetailInfo(val placeId:String, val name:String, val lat:Double, val lon:Double, val canuse:Boolean)
data class PlaceInfo(val placeId: String, val name: String, val canuse: Boolean)
data class FamilyId(val familyId: String)
data class FamilyInfo(val memberId: String, val name: String, val lastConnection:String)
